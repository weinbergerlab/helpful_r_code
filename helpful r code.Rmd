...
Make sure the packages in the following chunk are all installed (use install.packages())
```{r setup}
...
plot1<-plot_smooths(model=mod1, series=t2,  grp)
